...
class FlagDropdwonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: field(
          ...
          isRead: true,
          onTap: () {
            showModelSheet(context, size, flags);
          }),
    );
  ...
  //***************************************** show */
  showModelSheet(BuildContext context, Size size, List flags) {
          ...
          return SizedBox(
            ...
            child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  String current = flags[index];
                  return ListTile(
                    onTap: () {
                      flagCtrl.text = current;
