...
import '../../custom widgets/reason_grv_dropdwon_widget.dart';
import '../../utils/snackbar.dart';

import '../print/print_screen_modal_sheet.dart';
import 'grv_popUp_modal_sheet.dart';

class GrvPopUpFormBody extends StatefulWidget {
  ...
  @override
  State<GrvPopUpFormBody> createState() => _GrvPopUpFormBodyState();
}

class _GrvPopUpFormBodyState extends State<GrvPopUpFormBody> {
  final reason = [
    ...
    return Column(
      ...
      children: [
        ...
        ReasonDropdwonWidget(
          reasonCtrl: widget.reasonCtrl,
        ),
        // field(
        //     cntr: widget.reasonCtrl,
        //     context: context,
        //     txt: "Reason",
        //     number: true,
